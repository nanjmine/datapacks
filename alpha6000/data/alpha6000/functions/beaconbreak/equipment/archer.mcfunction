...
give @p cookie 64
give @p bow{HideFlags:127,Unbreakable:1b}
give @p arrow 64
...
execute as @p if entity @s[team=apblue] run give @s blue_stained_glass{CanPlaceOn:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:white_concrete","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon","minecraft:iron_block"],HideFlags:127} 64
...
execute as @p if entity @s[team=apgreen] run give @s green_stained_glass{CanPlaceOn:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:white_concrete","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon","minecraft:iron_block"],HideFlags:127} 64
...
execute as @p if entity @s[team=apyellow] run give @s yellow_stained_glass{CanPlaceOn:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:white_concrete","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon","minecraft:iron_block"],HideFlags:127} 64
