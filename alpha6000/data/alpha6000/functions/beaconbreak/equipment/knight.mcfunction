...
#common
give @p minecraft:stone_pickaxe{CanDestroy:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon",],HideFlags:127,Unbreakable:1b}
give @p diamond_sword{HideFlags:127,Unbreakable:1b}
give @p cookie 64
replaceitem entity @p armor.chest iron_chestplate{HideFlags:127,Enchantments:[{id:"minecraft:binding_curse",lvl:1s}],AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:-0.25,Operation:1,UUID:[I;1884723279,-899857986,-1616908790,1548461054],Slot:"chest"}]} 1
replaceitem entity @p weapon.offhand shield{AttributeModifiers:[{AttributeName:"generic.movement_speed",Name:"generic.movement_speed",Amount:-0.25,Operation:1,UUID:[I;1776964370,1491750654,-1301611715,-323833808],Slot:"offhand"}]}
#red
...
execute as @p if entity @s[team=apred] run give @s red_concrete{CanPlaceOn:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:white_concrete","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon","minecraft:iron_block"],HideFlags:127} 64
...
execute as @p if entity @s[team=apblue] run give @s blue_concrete{CanPlaceOn:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:white_concrete","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon","minecraft:iron_block"],HideFlags:127} 64
...
execute as @p if entity @s[team=apgreen] run give @s green_concrete{CanPlaceOn:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:white_concrete","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon","minecraft:iron_block"],HideFlags:127} 64
...
execute as @p if entity @s[team=apyellow] run give @s yellow_concrete{CanPlaceOn:["minecraft:red_wool","minecraft:blue_wool","minecraft:green_wool","minecraft:yellow_wool","minecraft:red_stained_glass","minecraft:blue_stained_glass","minecraft:green_stained_glass","minecraft:yellow_stained_glass","minecraft:white_concrete","minecraft:red_concrete","minecraft:blue_concrete","minecraft:green_concrete","minecraft:yellow_concrete","minecraft:red_terracotta","minecraft:blue_terracotta","minecraft:green_terracotta","minecraft:yellow_terracotta","minecraft:beacon","minecraft:iron_block"],HideFlags:127} 64
